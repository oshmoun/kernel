...
#define HFI_BUFFER_EXTRADATA_INPUT_LEGACY (HFI_OX_BASE + 0x2)
#define HFI_BUFFER_EXTRADATA_OUTPUT_LEGACY (HFI_OX_BASE + 0x3)
#define HFI_BUFFER_EXTRADATA_OUTPUT2_LEGACY (HFI_OX_BASE + 0x4)
